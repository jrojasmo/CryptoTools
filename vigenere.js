...
function vigenere(clearText, key, cipher){
    ...
    for (i=0; i<normalTextCodes.length; i++){
        ...
        if (cipher)
            ...
            normalTextCodes[i] = (normalTextCodes[i] - normalKeyCodes[indexKey] + 26) % 26;
    }
...
console.log(vigenereDecipher("ofsgivwiiksmidmensvlhsycijarajsexagjukgenmzvlwftcshrlslfxsdrylwihavrx", "ussr"));
...
//console.log(charFrecuency("ofsgivwiiksmidmensvlhsycijarajsexagjukgenmzvlwftcshrlslfxsdrylwihavrx"));
